...
public class SnakeGameHW11 extends JPanel implements Runnable{
    ...
    public void paintComponent (Graphics g){
        ...
        g.drawString("snake size: "+snake.size(),panelWidth-100,20);
        g.drawString("score: "+score,panelWidth-100,30);
        g.drawString("high score: "+highScore,panelWidth-100,40);
        if(gameOver){
    ...
    public static void main (String[] args){
        ...
        int panelWidth=500;
        SnakeGameHW11 myPanel=new SnakeGameHW11(panelWidth);
